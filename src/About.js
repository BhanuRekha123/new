...
function About() {
  return (
    <div className=" text-center">
      <h1 className="2xl:mt-32 mt-28 2xl:mb-8 mb-5 uppercase 2xl:text-4xl text-3xl font-semibold text-white">
        What are ReactJS and TailwindCSS?
      </h1>
      <div className="flex flex-row space-x-8 justify-center items-center">
        <div class="block 2xl:p-6 p-4 2xl:max-w-lg max-w-md 2xl:max-h-lg max-h-md bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100">
